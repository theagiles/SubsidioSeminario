...
class RegistroSubsidioPage extends StatefulWidget {
  RegistroSubsidioPage({Key key}) : super(key: key);

  @override
  _RegistroSubsidioPageState createState() => _RegistroSubsidioPageState();
}

class _RegistroSubsidioPageState extends State<RegistroSubsidioPage> {
  ...
  _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        _subsidio.fecha = picked.toIso8601String() + "Z";
        _inputDate.text = _subsidio.fecha;
      });
    }
  }
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      form.save();
      subsidioBloc.createSubsidio(_subsidio);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text(Constants.registroSubsidio)
      ),
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            onSaved: (String value) {
                              _subsidio.numero = int.parse(value);
                            },
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            onSaved: (String value) {
                              _subsidio.valor = int.parse(value);
                            },
                            style: TextStyle(fontSize: 18.0),
                          ),
                          Padding(
                          ...
                          DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              hint: Text(Constants.labelEstudiante),
                              ...
                              onChanged: (String newValue) {
                                ...
                                print(selectedEstudiante);
                                _subsidio.estudiante = newValue;
                              },
